define(function(){
    ...
    Checker.prototype.checkObject = function (sceneObject) {
        ...
        var cameraX0 = -0.05 * aspect * Math.tan(vFOV / 2) * this.camera.position.z;
        var cameraX1 =  0.05 * aspect * Math.tan(vFOV / 2) * this.camera.position.z;
        var cameraY0 = -0.05 * Math.tan(vFOV / 2) * this.camera.position.z;
        var cameraY1 =  0.05 * Math.tan(vFOV / 2) * this.camera.position.z;
